...
public class HelloController {
    ...
    public String getParamDemo2 (@RequestParam(value="param",required = false) String param){
        System.out.println("get param " + param);
        return " success get param "+param+" 汉1111字就乱码？？";
    }
    ...
    public String getRequestDemo (@RequestParam(value="param",required = false) String param){
